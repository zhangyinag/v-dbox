...
<div>
   ...
   <div :class="[$style.header]">
      <ul :class="$style.listGroup">
         ...
         <li :class="[$style.listGroupItem, activeCls('events')]" @click="changePanel('events')">EVENTS</li>
         <li :class="[$style.listGroupItem, activeCls('slots')]" @click="changePanel('slots')">SLOTS</li>
         <li :class="[$style.listGroupItem, activeCls('scopedSlots')]" @click="changePanel('scopedSlots')">SCOPED SLOTS</li>
         <li :class="[$style.listGroupItem, activeCls('methods')]" @click="changePanel('methods')">METHODS</li>
      </ul>
   </div>
...
export default class ApiTable extends Vue {
  ...
  @Prop(Array) slots: Array

  @Prop(Array) scopedSlots: Array

  @Prop(Array) events: Array

  @Prop(Array) methods: Array
